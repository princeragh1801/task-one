const PracticeTestItem: React.FC = () => {
  ...
  return (
    <div className="border border-gray-300 rounded-lg mb-3 overflow-hidden">
      <div className="text-sm text-left"> {/* Ensure text is left aligned */}
        {/* Row Items */}
        {data.map((item, index) => (
          <div
            key={index}
...
<div className="p-4 flex justify-center">
  <div className=" w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 rounded-md transition-all duration-200 text-center">
    Result
  </div>
</div>
